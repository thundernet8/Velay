...
function collectDataFromConstructor(vm, Component) {
    ...
    Object.keys(data).forEach(function (key) {
        if (data[key] !== undefined && !mobx.isObservable(data[key])) {
...
var MapHelperMap = {
    State: Vuex.mapState,
    Getter: Vuex.mapGetters,
    Action: Vuex.mapActions,
    Mutation: Vuex.mapMutations
};
/**
 * Vuex store class
 */
...
function handleStoreServiceBinding(key, value, vm) {
    ...
    //     index = undefined;
    // }
    value.__decorators__.forEach(function (decoratorDesc) {
        var bindTo = decoratorDesc.type === 'State' || decoratorDesc.type === 'Getter' ? 'computed' : 'methods';
        Ctor.__decorators__.push(function (options) {
            var _a;
            if (!options[bindTo]) {
                options[bindTo] = {};
            }
            var mapObject = (_a = {}, _a[decoratorDesc.key] = key, _a);
...
function injectService(Component) {
    ...
    Vue.mixin({
        beforeCreate: function () {
            ...
            paramKeys.forEach(function (key) {
                ...
                if (typeof instance[key] === 'function' || mobx.isObservable(instance[key])) {
...
function assembleComponent(Component, options) {
    ...
    return reactiveComponent(name, componentFactory(target, __assign({}, options, { name: name })));
}
