...
function Component(options) {
    ...
    if (typeof options === 'function') {
        ...
        return reactiveComponent(name_1, componentFactory(target, __assign({}, combineOptions, { name: name_1 })));
    }
    return function (Component) {
        ...
        return reactiveComponent(name, componentFactory(target, __assign({}, combineOptions, { name: name })));
    };
}
